...
/**
 * Contenido v1 tal como lo sembro la migracion 010 antes del contenido v2: copia
 * congelada para probar que la migracion 012 lo mejora sin pisar ediciones.
 * No se edita: si el contenido cambia, cambia `example-missions.ts`.
 */
export const EXAMPLE_MISSIONS_V1: readonly MissionDefinition[] = [
  {
